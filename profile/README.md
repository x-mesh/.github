...
<p align="center">
  <picture>
    ...
    <img src="./assets/layers.svg" width="900"
         alt="Five layers. Environment: term-mesh, where agents run. Harness: xm, what gets built and whether it ships. Context: mem-mesh, opt-in, what survives the session. Version control: gk, staying recoverable. Operations: aic, edc, httprove, dbops and x-backup, what broke after it shipped, each used on its own.">
  </picture>
</p>
